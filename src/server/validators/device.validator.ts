...
export const DeviceListQueryValidator = z.object({
  ...
  sortBy: z
    .enum(["name", "type", "sn", "power", "today", "total", "hours"])
    .default("name"),
...
export const DeviceCurrentAlertsQueryValidator = z.object({
  ...
  sortBy: z
    .enum(["name", "sn", "event", "severity", "startedAt", "lastUpdatedAt"])
...
export const DeviceLogsQueryValidator = z.object({
  ...
  sortBy: z
    .enum(["name", "type", "sn", "time", "status", "event"])
    .default("time"),
  sortOrder: z.enum(["asc", "desc"]).default("desc"),
});
...
export type DeviceLiveRowsQueryInput = z.infer<
  typeof DeviceLiveRowsQueryValidator
>;
...
export type DeviceChartExportQueryInput = z.infer<
  typeof DeviceChartExportQueryValidator
>;
export type DeviceCurrentAlertsQueryInput = z.infer<
  typeof DeviceCurrentAlertsQueryValidator
>;
export type DeviceInformationQueryInput = z.infer<
  typeof DeviceInformationQueryValidator
>;
export type DeviceInformationLiveQueryInput = z.infer<
  typeof DeviceInformationLiveQueryValidator
>;
export type DeviceInformationExportQueryInput = z.infer<
  typeof DeviceInformationExportQueryValidator
>;
export type DeviceLogsQueryInput = z.infer<typeof DeviceLogsQueryValidator>;
export type DeviceLogsExportQueryInput = z.infer<
  typeof DeviceLogsExportQueryValidator
>;
