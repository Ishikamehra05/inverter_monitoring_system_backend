...
// 	const firmwareUrl =
//   `http://solarlogger.in/api/v1/service/firmware/${firmwareResolution.firmwareId}`;
    const firmwareUrl = `http://fota.solarlogger.in/firmware/${firmwareResolution.firmwareUrl}`;
