...
"[project]/src/server/features/remote-settings/other-setting/other-setting.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "getOtherSettingSettings",
    ()=>getOtherSettingSettings,
    "submitOtherSettingSettings",
    ()=>submitOtherSettingSettings
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/shared/inverter-scope.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/db/prisma.ts [app-route] (ecmascript)");
...
async function getOtherSettingSettings(scope, plantId, deviceId) {
...
async function submitOtherSettingSettings(scope, plantId, deviceId, settings, updatedById) {
    const inverter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getScopedInverterOrThrow"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"], scope, plantId, deviceId);
...
"[project]/src/server/features/remote-settings/other-setting/other-setting.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/other-setting/other-setting.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function getOtherSetting(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOtherSettingSettings"])(scope, params.plantId, params.deviceId);
...
async function submitOtherSetting(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitOtherSettingSettings"])(scope, params.plantId, params.deviceId, params.settings, toBigIntUserId(params.user.userId));
...
"[project]/src/server/features/remote-settings/other-setting/other-setting.schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>otherSettingQuerySchema,
    "otherSettingSettingsSchema",
    ()=>otherSettingSettingsSchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const otherSettingQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
const otherSettingSettingsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    afdFunction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    powerOn: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    gridVoltageType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'Single Phase',
        'Three Phase'
    ]).optional()
});
const otherSettingBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
"[project]/src/app/api/v1/monitor/devices/[deviceId]/remote-settings/other-setting/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/other-setting/other-setting.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/other-setting/other-setting.schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function parseScopeQuery(request) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["otherSettingQuerySchema"].safeParse({
...
async function getOtherSettingRoute(request, context) {
    const authenticatedRequest = request;
    ...
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOtherSetting"])({
            user: buildUser(auth),
            deviceId,
...
async function postOtherSettingRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const parsedQuery = parseScopeQuery(request);
    ...
    const parsedBody = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["otherSettingBodySchema"].safeParse(body);
    ...
    const { deviceId } = await context.params;
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$other$2d$setting$2f$other$2d$setting$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitOtherSetting"])({
            user: buildUser(auth),
            deviceId,
            plantId: parsedQuery.data.plantId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02tvw0~._.js.map