...
"[project]/src/server/repositories/auth.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/server/utils/jwt.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAccessTokenExpiry(remember) {
    return remember ? process.env.JWT_ACCESS_EXPIRES_IN_REMEMBER ?? '7d' : process.env.JWT_ACCESS_EXPIRES_IN ?? '15m';
}
...
"[project]/src/server/services/auth.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$auth$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/repositories/auth.repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/jwt.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$auth$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$auth$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
function resolveRedirect(portal) {
...
class AuthService {
    authRepository;
    constructor(authRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$auth$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthRepository"]()){
        this.authRepository = authRepository;
    }
    async login(input) {
        const accessSecret = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccessTokenSecret"])();
        const refreshSecret = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRefreshTokenSecret"])();
        ...
        const accountRecord = await this.authRepository.findByPortalAndAccount(input.portal, input.account);
        if (!accountRecord) {
            return {
                status: 401,
        ...
        const isValidPassword = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])({
        ...
        const expiresIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccessTokenExpiry"])(input.remember);
        const accessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signAccessToken"])({
            userId: accountRecord.userId,
            role: accountRecord.role,
            portal: input.portal,
            account: input.account
        }, accessSecret, expiresIn);
        const refreshExpiresIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRefreshTokenExpiry"])();
        const refreshToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signRefreshToken"])({
            userId: accountRecord.userId,
            portal: input.portal,
            account: input.account
    ...
    async register(input) {
        ...
        if (typeof expectedVerificationCode === 'string' && expectedVerificationCode.length > 0 && input.verificationCode !== expectedVerificationCode) {
            return {
                status: 400,
                message: 'Invalid verification code'
            };
        }
        const existingAccount = await this.authRepository.findByPortalAndAccount('monitoring', input.account);
        if (existingAccount) {
            return {
                status: 409,
        ...
        const existingEmail = await this.authRepository.findByPortalAndEmail('monitoring', input.email);
        if (existingEmail) {
            return {
                status: 409,
    ...
    async refresh(input) {
        ...
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyRefreshToken"])(input.refreshToken, refreshSecret);
        if (!payload) {
            return {
                status: 401,
        ...
        if (typeof portal !== 'string' || portal !== 'monitoring' && portal !== 'service' || typeof account !== 'string' || account.length === 0 || typeof userId !== 'string' || userId.length === 0) {
            return {
                status: 401,
                message: 'Invalid refresh token payload'
            };
        }
        const accountRecord = await this.authRepository.findByPortalAndAccount(portal, account);
        ...
        const expiresIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccessTokenExpiry"])(false);
        const accessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signAccessToken"])({
            userId: accountRecord.userId,
            role: accountRecord.role,
            portal: portal,
...
"[project]/src/server/validators/auth.validator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const portalSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
    'monitoring',
    'service'
]);
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    portal: portalSchema,
    account: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1),
    ...
    remember: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional().default(false)
});
const registerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    timezone: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, 'Timezone is required'),
    verificationCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, 'Verification code is required')
...
const refreshSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    refreshToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1)
});
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/services/auth.service.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$auth$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/validators/auth.validator.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
const authService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthService"]();
function getClientIp(request) {
    const forwardedFor = request.headers.get('x-forwarded-for');
    if (forwardedFor) {
        const firstForwardedIp = forwardedFor.split(',')[0]?.trim();
...
async function postLogin(request) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$auth$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].safeParse(body);
    if (!parsed.success) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Invalid request body', 400);
    }
    ...
    const response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(result.message, {
...
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])(postLogin, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0hl~q0_._.js.map