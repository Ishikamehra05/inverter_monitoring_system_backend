...
"[project]/src/server/mqtt/client.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mqtt$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/mqtt/build/index.js [app-route] (ecmascript)");
;
function createMqttClient() {
    ...
    const client = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mqtt$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect(brokerUrl, {
...
const mqttClient = globalThis.__mqttClient ?? createMqttClient();
if ("TURBOPACK compile-time truthy", 1) {
    globalThis.__mqttClient = mqttClient;
}
}),
"[project]/src/server/mqtt/publish-remote-setting.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "publishRemoteSettingPattern",
    ()=>publishRemoteSettingPattern
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$mqtt$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/mqtt/client.ts [app-route] (ecmascript)");
;
...
function publishRemoteSettingPattern(pattern) {
    ...
    return new Promise((resolve)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$mqtt$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mqttClient"].publish(topic, pattern, {
            qos: 1,
            retain: false
        }, (error)=>{
            if (settled) return;
...
"[project]/src/server/features/remote-settings/shared/inverter-scope.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "getScopedInverterOrThrow",
    ()=>getScopedInverterOrThrow
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/db/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
async function getScopedInverterOrThrow(dbClient, scope, plantId, deviceId) {
    if (!scope || scope.length === 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](403, 'Unauthorized access to plant devices');
    }
    ...
    if (!inverter) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](404, 'Device not found. Remote settings are only available for inverters.');
    }
    return inverter;
}
;
...
"[project]/src/server/features/remote-settings/shared/parameter-master.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/shared/inverter-scope.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/db/prisma.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
async function getRegisterMap(tab) {
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].remoteSettingParameterMaster.findMany({
        where: {
            tab
        },
        select: {
...
function pickRegisters(registerMap, keys) {
    return Object.fromEntries(keys.map((key)=>[
            key,
            registerMap[key] ?? null
        ]));
}
async function getReadPattern(tab) {
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].remoteSettingParameterMaster.findMany({
        where: {
            tab,
            registerAddress: {
...
function encodeWriteValue(value) {
...
async function getWritePattern(tab, settings) {
    const rows = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].remoteSettingParameterMaster.findMany({
        where: {
            tab,
            registerAddress: {
    ...
    const registerByFieldKey = new Map(rows.map((row)=>[
            row.fieldKey,
            row
        ]));
    const entries = [];
...
"[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getGridParametersSettings(scope, plantId, deviceId) {
    const inverter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getScopedInverterOrThrow"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"], scope, plantId, deviceId);
    ...
    // });
    const row = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].deviceRemoteSetting.findFirst({
        where: {
...
async function submitGridParametersSettings(scope, plantId, deviceId, settings, updatedById) {
    const inverter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getScopedInverterOrThrow"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"], scope, plantId, deviceId);
    const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        const existing = await tx.deviceRemoteSetting.findUnique({
            where: {
                deviceInverterId_tab: {
                    deviceInverterId: 866192071837544,
                    tab: TAB
                }
            },
...
"[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$mqtt$2f$publish$2d$remote$2d$setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/mqtt/publish-remote-setting.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/shared/parameter-master.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function resolveScope(user, fromService, targetEndUserId) {
...
function toBigIntUserId(userId) {
    if (!/^\d+$/.test(userId)) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'Invalid authenticated user id');
    }
    return BigInt(userId);
}
async function getGridParameters(params) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGridParametersSettings"])(scope, params.plantId, params.deviceId);
    // console.log(result);
    const registers = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRegisterMap"])(TAB);
    const read_pattern = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReadPattern"])(TAB);
    const mqtt_published = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$mqtt$2f$publish$2d$remote$2d$setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publishRemoteSettingPattern"])(read_pattern);
...
async function submitGridParameters(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitGridParametersSettings"])(scope, params.plantId, params.deviceId, params.settings, toBigIntUserId(params.user.userId));
    const registerMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRegisterMap"])(TAB);
    const registers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pickRegisters"])(registerMap, Object.keys(params.settings));
    const read_pattern = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getReadPattern"])(TAB);
    const { pattern: write_pattern, unmappedFields: unmapped_fields } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWritePattern"])(TAB, params.settings);
    const mqtt_published = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$mqtt$2f$publish$2d$remote$2d$setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publishRemoteSettingPattern"])(write_pattern);
    return {
        ...result,
        registers,
        read_pattern,
...
"[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>gridParametersQuerySchema,
    "gridParametersSettingsSchema",
    ()=>gridParametersSettingsSchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const gridParametersQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required')
});
const gridParametersSettingsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    standardCode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'IN',
        'EU',
        'AU'
    ]).optional(),
    firstConnectDelayTime: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    reconnectDelayTime: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    firstConnectPowerGradient: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    reconnectPowerGradient: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridFirstConnectionVoltageHighLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridFirstConnectionVoltageLowLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridFirstConnectionFrequencyHighLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridFirstConnectionFrequencyLowLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridReconnectionVoltageHighLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridReconnectionVoltageLowLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridReconnectionFrequencyHighLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    gridReconnectionFrequencyLowLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    frequencyHighLossLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    frequencyLowLossLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageHighLossLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageLowLossLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    frequencyHighLossTimeLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    frequencyLowLossTimeLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageHighLossTimeLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageLowLossTimeLevel1: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageHighLossLevel2: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageLowLossLevel2: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageHighLossTimeLevel2: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    voltageLowLossTimeLevel2: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    overFrequencyDeratingFunction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    underFrequencyFunction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    overVoltageDerating: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional()
});
const gridParametersBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    sn: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
...
"[project]/src/app/api/v1/monitor/devices/[deviceId]/remote-settings/grid-parameters/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/grid-parameters/grid-parameters.schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function parseScopeQuery(request) {
    const searchParams = new URL(request.url).searchParams;
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gridParametersQuerySchema"].safeParse({
...
async function getGridParametersRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const parsedQuery = parseScopeQuery(request);
    if (!parsedQuery.success) {
        const issue = parsedQuery.error.issues[0];
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(issue ? `${issue.path.join('.') || 'query'}: ${issue.message}` : 'Invalid query parameters', 400);
    }
    const { deviceId } = await context.params;
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGridParameters"])({
            user: buildUser(auth),
            deviceId,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])('Remote settings fetched successfully.', settings);
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"]) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(error.message, error.statusCode);
        console.error(error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Failed to fetch remote settings', 500);
    }
}
async function postGridParametersRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const parsedQuery = parseScopeQuery(request);
    ...
    try {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Invalid JSON payload', 400);
    }
    const parsedBody = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["gridParametersBodySchema"].safeParse(body);
    if (!parsedBody.success) {
        const issue = parsedBody.error.issues[0];
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(issue ? `${issue.path.join('.') || 'body'}: ${issue.message}` : 'Invalid request body', 400);
    }
    const { deviceId } = await context.params;
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$grid$2d$parameters$2f$grid$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitGridParameters"])({
            user: buildUser(auth),
            deviceId,
            plantId: parsedQuery.data.plantId,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])('Remote settings submitted successfully.', result);
    } catch (error) {
        if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"]) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(error.message, error.statusCode);
        console.error(error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Failed to submit remote settings', 500);
    }
}
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(getGridParametersRoute), {
    routeName: 'monitor.devices.remoteSettings.gridParameters.get'
});
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(postGridParametersRoute), {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_-hea_._.js.map