...
"[project]/src/server/repositories/device.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DeviceRepository {
    ...
    mapDeviceRows(devices) {
        return devices.map((device)=>({
                ...
                hours: {
                    value: Number((device.hTotalValue ?? 0).toFixed(2)),
                    unit: "h"
                },
                online: device.status?.toLowerCase() === "online" ? true : Boolean(device.online),
                status: device.status ?? "offline",
                updatedAt: this.formatDateTime(device.updatedAt ?? device.updateTime ?? device.createdAt)
            }));
    }
    sortRows(rows, sortBy, sortOrder) {
        const multiplier = sortOrder === "asc" ? 1 : -1;
        return rows.sort((left, right)=>{
            if (sortBy === "power") return (left.power.value - right.power.value) * multiplier;
            if (sortBy === "today") return (left.today.value - right.today.value) * multiplier;
            if (sortBy === "total") return (left.total.value - right.total.value) * multiplier;
            if (sortBy === "hours") return (left.hours.value - right.hours.value) * multiplier;
    ...
    // 		};
    // 	}
    async getPlantDeviceList(params) {
        await this.getScopedPlantOrThrow(params.scope, params.plantId);
        const [inverters, dataloggers] = await Promise.all([
            this.dbClient.deviceInverter.findMany({
                where: {
        ...
        const latestMap = new Map(latestLogs.map((log)=>[
                log.sno,
                log
            ]));
        const statusMap = new Map(connectionStatuses.map((item)=>[
                item.serialNumber,
                item.status
            ]));
        const enrichedInverters = inverters.map((inverter)=>{
    ...
    async getPlantDeviceLiveRows(params) {
        await this.getScopedPlantOrThrow(params.scope, params.plantId);
    ...
    // }
    async addPlantInverter(params) {
        await this.getScopedPlantOrThrow(params.scope, params.plantId);
        const user = await this.dbClient.user.findUnique({
            where: {
                account: params.scope[0]
            },
            select: {
                id: true
            }
        ...
        return {
            deviceId: `device-${String(created.id)}`
        };
    }
    ...
    async getDeviceView(params) {
        ...
        if (inverter) {
            ...
            const connectionStatus = await this.dbClient.deviceConnectionStatus.findFirst({
                where: {
        ...
        if (!datalogger) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](404, "Device not found");
        }
    ...
    async getDeviceDayChartLogs(params) {
    ...
    async getDeviceMonthChartLogs(params) {
    ...
    async getDeviceYearChartLogs(params) {
        const current = new Date(params.date);
    ...
    async getDeviceChartSnapshot(params) {
        ...
        if (!datalogger) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](404, "Device not found for this plant.");
        }
    ...
    async getDeviceCurrentAlertsSnapshot(params) {
        const plantId = this.parsePlantId(params.plantId);
        const deviceId = this.parseDeviceId(params.deviceId);
        const plant = await this.dbClient.plant.findFirst({
            where: {
    ...
    async getDeviceInformationRealtimeSnapshot(params) {
        const inverter = await this.dbClient.deviceInverter.findFirst({
            where: {
    ...
    async getDeviceInformationSnapshot(params) {
        const plantId = this.parsePlantId(params.plantId);
        const deviceId = this.parseDeviceId(params.deviceId);
        const plant = await this.dbClient.plant.findFirst({
            where: {
        ...
        if (inverter) {
            const latestLog = inverter.serialNumber ? await this.dbClient.deviceLogsLatest.findFirst({
                where: {
                    sno: inverter.serialNumber
                },
                orderBy: {
            ...
            return {
                ...
                device: {
                    ...
                    updatedAt: latestLog?.latestTimestamp ?? inverter.updateTime ?? inverter.updatedAt,
...
"[project]/src/server/services/device.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "getPlantDeviceList",
    ()=>getPlantDeviceList,
    "getPlantDeviceLiveRows",
    ()=>getPlantDeviceLiveRows
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$device$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/repositories/device.repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$device$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
class DeviceService {
    deviceRepository;
    constructor(deviceRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$device$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceRepository"]()){
        this.deviceRepository = deviceRepository;
        this.userRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserRepository"]();
    }
    formatDateTime(value) {
        const date = value ?? new Date();
    ...
    assertPlantAccess(scope, account) {
        if (!scope || scope.length === 0) {
        ...
        if (!scope.includes(account)) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](403, 'You do not have access to this device.');
        }
    }
    ...
    // 	];
    // }
    filterLiveRefreshItems(items, since) {
        if (!since) {
            return items;
        }
        const sinceDate = new Date(since);
        if (Number.isNaN(sinceDate.getTime())) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'Invalid since timestamp');
        }
        return items.filter((item)=>new Date(item.lastUpdatedAt).getTime() > sinceDate.getTime());
    }
    sortCurrentAlertItems(items, sortBy, sortOrder) {
        const multiplier = sortOrder === 'asc' ? 1 : -1;
        return [
            ...items
        ].sort((left, right)=>{
    ...
    formatInfoDateTime(value) {
        return value.toISOString().replace('T', ' ').slice(0, 19);
    }
    validateDateRange(dateFrom, dateTo) {
        if (dateFrom && !dateTo || !dateFrom && dateTo) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'dateFrom and dateTo must be provided together');
        }
        if (!dateFrom || !dateTo) {
            return;
        }
        ...
        if (Number.isNaN(from.getTime()) || Number.isNaN(to.getTime())) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'Invalid date range');
        }
        if (from > to) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'dateFrom must be less than or equal to dateTo');
        }
    }
    resolveRangeFactor(dateFrom, dateTo) {
        if (!dateFrom || !dateTo) {
            return 1;
        }
        const from = new Date(`${dateFrom}T00:00:00.000Z`);
    ...
    // 	};
    // }
    toDeviceInformationData(snapshot, dateFrom, dateTo) {
        ...
        const stringStats = Array.from({
            length: 9
        }, (_, i)=>({
                key: `string${i + 1}`,
                label: `String${i + 1}`,
                value: `${log[`dc_voltage_${i + 1}`] ?? 0} V / ${log[`dc_current_${i + 1}`] ?? 0} A`
            }));
        return {
            device: {
                id: `device-${snapshot.device.id}`,
                ...
                type: snapshot.device.type,
                sn: snapshot.device.serialNumber,
                status: this.resolveDeviceStatus(true, String(log.inverter_status ?? ''))
            },
            basicStats,
            stringStats,
    ...
    toDeviceTypeLabel(type) {
        return type.length > 0 ? `${type[0].toUpperCase()}${type.slice(1)}` : 'Device';
    }
    generateDeviceLogs(snapshot, dateFrom, dateTo) {
    ...
    applyDeviceLogFilters(rows, search, event) {
        ...
        return rows.filter((item)=>{
            ...
            return item.name.toLowerCase().includes(normalizedSearch) || item.sn.toLowerCase().includes(normalizedSearch);
        });
    }
    sortDeviceLogs(rows, sortBy, sortOrder) {
        const multiplier = sortOrder === 'asc' ? 1 : -1;
        return [
            ...rows
        ].sort((left, right)=>{
    ...
    async buildFilteredDeviceLogsData(params) {
    ...
    async toChartResponse(snapshot, params) {
        const device = {
            id: `device-${snapshot.device.id}`,
            name: snapshot.device.name,
            sn: snapshot.device.sn,
        ...
        if (!params.date) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'Date is required');
        }
        if (params.range === 'day') {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"](400, 'Invalid chart range');
    }
    getPlantDeviceList(params) {
        return this.deviceRepository.getPlantDeviceList(params);
    }
    getPlantDeviceLiveRows(params) {
        return this.deviceRepository.getPlantDeviceLiveRows(params);
    }
    addPlantInverter(params) {
        return this.deviceRepository.addPlantInverter(params);
    }
    getDeviceView(params) {
    ...
    async exportDeviceChart(params) {
    ...
    // 	return payload;
    // }
    async getDeviceInformation(params) {
        this.validateDateRange(params.dateFrom, params.dateTo);
        const scope = await this.resolveScope(params.user, params.fromService, params.targetEndUserId);
        const repoParams = {
            plantId: params.plantId,
        ...
        const snapshot = await this.deviceRepository.getDeviceInformationRealtimeSnapshot(repoParams);
        if (!snapshot) {
    ...
    // }
    async exportDeviceInformation(params) {
    ...
    async exportDeviceLogs(params) {
        ...
        for (const item of result.items){
            rows.push(headers.map((key)=>String(item[key] ?? '')).join(','));
        }
        return {
...
"[project]/src/server/validators/device.validator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DeviceAddBodyValidator",
    ()=>DeviceAddBodyValidator,
    "DeviceChartExportQueryValidator",
    ()=>DeviceChartExportQueryValidator,
    "DeviceChartQueryValidator",
    ()=>DeviceChartQueryValidator,
    "DeviceCurrentAlertsQueryValidator",
    ()=>DeviceCurrentAlertsQueryValidator,
    "DeviceDeleteBodyValidator",
    ()=>DeviceDeleteBodyValidator,
    "DeviceEditBodyValidator",
    ()=>DeviceEditBodyValidator,
    "DeviceInformationExportQueryValidator",
    ()=>DeviceInformationExportQueryValidator,
    "DeviceInformationLiveQueryValidator",
    ()=>DeviceInformationLiveQueryValidator,
    "DeviceInformationQueryValidator",
    ()=>DeviceInformationQueryValidator,
    "DeviceListQueryValidator",
    ()=>DeviceListQueryValidator,
    "DeviceLiveRowsQueryValidator",
    ()=>DeviceLiveRowsQueryValidator,
    "DeviceLogsExportQueryValidator",
    ()=>DeviceLogsExportQueryValidator,
    "DeviceLogsQueryValidator",
    ()=>DeviceLogsQueryValidator,
    "DeviceViewQueryValidator",
    ()=>DeviceViewQueryValidator
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const DeviceListQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
const DeviceLiveRowsQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    deviceIds: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'deviceIds is required')
});
const DeviceAddBodyValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    serialNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'serialNumber is required')
});
const DeviceViewQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
...
const DeviceEditBodyValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'name is required')
});
const DeviceDeleteBodyValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
const DeviceChartQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
const DeviceChartExportQueryValidator = DeviceChartQueryValidator.extend({
...
const DeviceCurrentAlertsQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
    ...
    page: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).default(1),
    pageSize: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).max(100).default(10),
    since: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().datetime().optional(),
    sortBy: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'name',
        'sn',
        'event',
...
const DeviceInformationQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
    dateFrom: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^\d{4}-\d{2}-\d{2}$/, 'dateFrom must be YYYY-MM-DD').optional(),
    dateTo: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().regex(/^\d{4}-\d{2}-\d{2}$/, 'dateTo must be YYYY-MM-DD').optional()
});
const DeviceInformationLiveQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
const DeviceInformationExportQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
const DeviceLogsQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
const DeviceLogsExportQueryValidator = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    role: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    fromService: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    targetEndUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
    plantId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, 'plantId is required'),
...
"[project]/src/app/api/v1/monitor/plants/[plantId]/devices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$device$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/services/device.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$scope$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/scope-resolver.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$device$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/validators/device.validator.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/repositories/user.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$device$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$device$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function resolveScope(user, fromService, targetEndUserId) {
    if (fromService && (user.role === 'service_admin' || user.role === 'service_super_admin') && targetEndUserId) {
        return [
            targetEndUserId
        ];
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$scope$2d$resolver$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveUserScope"])(user);
}
async function getPlantDevicesRoute(request, context) {
    const authenticatedRequest = request;
    ...
    const parsedQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$device$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceListQueryValidator"].safeParse({
    ...
    const hasServiceRole = user.role === 'service_admin' || user.role === 'service_super_admin';
    let scope = baseScope;
    if (parsedQuery.data.fromService && hasServiceRole && parsedQuery.data.targetEndUserId) {
        const accountScope = await userRepository.getAccountScopeByUserId(parsedQuery.data.targetEndUserId);
        if (!accountScope) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Selected end user not found', 404);
        }
        scope = accountScope;
    }
    console.log({
    ...
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$device$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPlantDeviceList"])({
            scope,
            plantId,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])('Plant devices fetched successfully.', data);
    } catch (error) {
        console.error('FULL ERROR =>', error);
        throw error;
    }
}
async function postPlantDeviceRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const user = buildUser(auth);
    ...
    const parsedBody = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$device$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DeviceAddBodyValidator"].safeParse(body);
    ...
    const { plantId } = await context.params;
    try {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$device$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addPlantInverter"])({
            scope,
            plantId,
            serialNumber: parsedBody.data.serialNumber
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])('Inverter added successfully.', data);
    } catch (error) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Failed to add inverter', 500);
    }
}
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(getPlantDevicesRoute), {
    routeName: 'monitor.plants.devices.list'
});
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(postPlantDeviceRoute), {
    routeName: 'monitor.plants.devices.add'
});
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0adqer~._.js.map