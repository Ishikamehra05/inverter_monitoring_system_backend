...
"[project]/src/server/features/remote-settings/power-limit/power-limit.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "getPowerLimitSettings",
    ()=>getPowerLimitSettings,
    "submitPowerLimitSettings",
    ()=>submitPowerLimitSettings
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/shared/inverter-scope.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/db/prisma.ts [app-route] (ecmascript)");
...
async function getPowerLimitSettings(scope, plantId, deviceId) {
...
async function submitPowerLimitSettings(scope, plantId, deviceId, settings, updatedById) {
    const inverter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getScopedInverterOrThrow"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"], scope, plantId, deviceId);
...
"[project]/src/server/features/remote-settings/power-limit/power-limit.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/power-limit/power-limit.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function getPowerLimit(params) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPowerLimitSettings"])(scope, params.plantId, params.deviceId);
...
async function submitPowerLimit(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitPowerLimitSettings"])(scope, params.plantId, params.deviceId, params.settings, toBigIntUserId(params.user.userId));
...
"[project]/src/server/features/remote-settings/power-limit/power-limit.schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>powerLimitQuerySchema,
    "powerLimitSettingsSchema",
    ()=>powerLimitSettingsSchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const powerLimitQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
const powerLimitSettingsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    powerControl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'Disable',
        'Enable'
    ]).optional(),
    meterLocation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'Grid side',
        'Load side'
    ]).optional(),
    powerFlowDirection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'Export',
        'Import'
    ]).optional(),
    maxFeedInGridPower: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    modbusAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional()
});
const powerLimitBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
"[project]/src/app/api/v1/monitor/devices/[deviceId]/remote-settings/power-limit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/power-limit/power-limit.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/power-limit/power-limit.schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function parseScopeQuery(request) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["powerLimitQuerySchema"].safeParse({
...
async function getPowerLimitRoute(request, context) {
    const authenticatedRequest = request;
    ...
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPowerLimit"])({
            user: buildUser(auth),
            deviceId,
...
async function postPowerLimitRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const parsedQuery = parseScopeQuery(request);
    ...
    const parsedBody = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["powerLimitBodySchema"].safeParse(body);
    ...
    const { deviceId } = await context.params;
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$power$2d$limit$2f$power$2d$limit$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitPowerLimit"])({
            user: buildUser(auth),
            deviceId,
            plantId: parsedQuery.data.plantId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0i52w5x._.js.map