...
"[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "getFeatureParametersSettings",
    ()=>getFeatureParametersSettings,
    "submitFeatureParametersSettings",
    ()=>submitFeatureParametersSettings
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/shared/inverter-scope.ts [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/db/prisma.ts [app-route] (ecmascript)");
...
async function getFeatureParametersSettings(scope, plantId, deviceId) {
...
async function submitFeatureParametersSettings(scope, plantId, deviceId, settings, updatedById) {
    const inverter = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$inverter$2d$scope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getScopedInverterOrThrow"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"], scope, plantId, deviceId);
...
"[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.repository.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$shared$2f$parameter$2d$master$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function getFeatureParameters(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFeatureParametersSettings"])(scope, params.plantId, params.deviceId);
...
async function submitFeatureParameters(params) {
    const scope = await resolveScope(params.user, params.fromService, params.targetEndUserId);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitFeatureParametersSettings"])(scope, params.plantId, params.deviceId, params.settings, toBigIntUserId(params.user.userId));
...
"[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.schema.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "featureParametersBodySchema",
    ()=>featureParametersBodySchema,
    "featureParametersQuerySchema",
    ()=>featureParametersQuerySchema,
    "featureParametersSettingsSchema",
    ()=>featureParametersSettingsSchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const featureParametersQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
const featureParametersSettingsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    faultRideThroughFunction: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    islandDetection: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    terminalResistor: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional(),
    deratedPower: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    insulationImpedance: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    leakageCurrentPoint: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional(),
    movingAverageVoltageLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().optional()
});
const featureParametersBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
...
"[project]/src/app/api/v1/monitor/devices/[deviceId]/remote-settings/feature-parameters/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/features/remote-settings/feature-parameters/feature-parameters.schema.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function parseScopeQuery(request) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["featureParametersQuerySchema"].safeParse({
...
async function getFeatureParametersRoute(request, context) {
    const authenticatedRequest = request;
    ...
    try {
        const settings = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFeatureParameters"])({
            user: buildUser(auth),
            deviceId,
...
async function postFeatureParametersRoute(request, context) {
    const authenticatedRequest = request;
    const auth = authenticatedRequest.auth;
    if (!auth?.userId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Unauthorized', 401);
    const parsedQuery = parseScopeQuery(request);
    ...
    const parsedBody = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["featureParametersBodySchema"].safeParse(body);
    ...
    const { deviceId } = await context.params;
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$features$2f$remote$2d$settings$2f$feature$2d$parameters$2f$feature$2d$parameters$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["submitFeatureParameters"])({
            user: buildUser(auth),
            deviceId,
            plantId: parsedQuery.data.plantId,
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(getFeatureParametersRoute), {
    routeName: 'monitor.devices.remoteSettings.featureParameters.get'
});
const POST = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(postFeatureParametersRoute), {
    routeName: 'monitor.devices.remoteSettings.featureParameters.post'
});
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0sjuhi.._.js.map