...
"[project]/src/server/repositories/monitor-user.repository.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MonitorUserRepository {
    ...
    async getLatestInverterTotals(serialNumbers) {
        const filterClause = serialNumbers && serialNumbers.length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$generated$2f$prisma$2f$internal$2f$prismaNamespace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Prisma$3e$__["Prisma"].sql`WHERE dll.sno IN (${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$generated$2f$prisma$2f$internal$2f$prismaNamespace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Prisma$3e$__["Prisma"].join(serialNumbers)})` : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2f$generated$2f$prisma$2f$internal$2f$prismaNamespace$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Prisma$3e$__["Prisma"].empty;
    ...
    async getScopedSerialNumbers(accounts) {
    ...
    findScopedMonitorUsers(actorId, actorRole) {
        return this.dbClient.user.findMany({
            where: {
                portal: "monitoring",
                role: "monitoring_user",
    ...
    // 	});
    // }
    async getPlantStatusCountsForUsers(accounts) {
    ...
    async findPlantStatusesByPlantIds(plantIds) {
    ...
    findScopedMonitorUsersByIds(actorId, actorRole, monitorUserIds) {
        return this.dbClient.user.findMany({
            where: {
                id: {
                    in: monitorUserIds
    ...
    findScopedMonitorUser(actorId, actorRole, monitorUserId) {
    ...
    findAssignersByIds(assignerIds) {
        return this.dbClient.user.findMany({
            where: {
                id: {
                    in: assignerIds
    ...
    findInvertersByPlantIds(plantIds) {
    ...
    async findLatestLogsBySerialNumbers(serialNumbers) {
    ...
    findDataloggersByPlantIds(plantIds) {
    ...
    countPlantsByUserAccount(userAccount) {
    ...
    findPlantsByUserAccount(userAccount, page, pageSize) {
        return this.dbClient.plant.findMany({
            where: {
                userAccount,
                deletedAt: null
    ...
    findTargetServiceUser(targetUserId) {
        return this.dbClient.user.findFirst({
            where: {
                id: targetUserId,
                portal: "service",
    ...
    findScopedMonitorUserIds(actorId, actorRole, monitorUserIds) {
        return this.dbClient.user.findMany({
            where: {
                id: {
                    in: monitorUserIds
    ...
    updateMonitorUsersAssignedBy(actorId, actorRole, monitorUserIds, targetUserId) {
    ...
    async findMonitorUserByAccount(account) {
        return this.dbClient.user.findFirst({
            where: {
                account,
                portal: 'monitoring',
    ...
    async findMappingBySerialNumber(serialNumber) {
    ...
    async createUserPlantMapping(userId, serialNumber) {
    ...
    findByAccountInsensitive(account) {
        return this.dbClient.user.findFirst({
            where: {
                account: {
                    equals: account,
    ...
    findUserIdsByAccounts(accounts) {
        return this.dbClient.user.findMany({
            where: {
                account: {
                    in: accounts,
    ...
    findMonitoringUserByEmail(email) {
        return this.dbClient.user.findFirst({
            where: {
                portal: "monitoring",
                email: {
    ...
    async getDashboardSummary(actorId, role) {
...
"[project]/src/server/utils/password.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function verifyPassword({ plainPassword, storedPassword, storedPasswordHash }) {
    if (storedPasswordHash) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compare"])(plainPassword, storedPasswordHash);
    }
    if (storedPassword) {
...
async function hashPassword(plainPassword) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hash"])(plainPassword, PASSWORD_SALT_ROUNDS);
}
}),
"[project]/src/server/services/monitor-user.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$monitor$2d$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/repositories/monitor-user.repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/api-error.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/utils/password.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$monitor$2d$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$monitor$2d$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
function computeRowStatus(entries) {
    const rowStatus = {
        online: 0,
        abnormal: 0,
        standby: 0,
...
function hasStatusMatch(statusFilter, status) {
    if (statusFilter === "all") {
        return true;
    }
...
class MonitorUserService {
    monitorUserRepository;
    constructor(monitorUserRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$repositories$2f$monitor$2d$user$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MonitorUserRepository"]()){
        this.monitorUserRepository = monitorUserRepository;
    }
    async getActor(actorId) {
        return this.monitorUserRepository.findActorById(actorId);
    }
    async validateActor(actorId, actorRole) {
    ...
    async fetchScopedMonitorUsers(actorId, actorRole) {
        return this.monitorUserRepository.findScopedMonitorUsers(actorId, actorRole);
    }
    async buildSummaries(monitorUsers, filters) {
        if (monitorUsers.length === 0) {
            return [];
        }
        const accounts = monitorUsers.map((user)=>user.account);
        const assignerIds = Array.from(new Set(monitorUsers.map((user)=>user.assignedById).filter((id)=>typeof id === "bigint")));
        ...
        const plantStatuses = plantIds.length > 0 ? await this.monitorUserRepository.findPlantStatusesByPlantIds(plantIds) : [];
        const inverters = plantIds.length > 0 ? await this.monitorUserRepository.findInvertersByPlantIds(plantIds) : [];
        const serialNumbers = inverters.map((item)=>item.serialNumber);
        const latestLogs = serialNumbers.length > 0 ? await this.monitorUserRepository.findLatestLogsBySerialNumbers(serialNumbers) : [];
        const affiliationById = new Map(assigners.map((item)=>[
                String(item.id),
                item.account
            ]));
        ...
        const logsBySerial = new Map(latestLogs.map((log)=>[
                log.sno,
                log
            ]));
        ...
        const statusByPlantId = new Map(plantStatuses.map((status)=>[
                String(status.plantId),
                status
            ]));
        const summaries = [];
        const deviceEntries = [];
        for (const user of monitorUsers){
            const affiliation = typeof user.assignedById === "bigint" && affiliationById.get(String(user.assignedById)) || "";
            ...
            for (const plant of userPlants){
                ...
                for (const inverter of plantInverters){
                    ...
                    if (searchSN.length > 0 && inverter.serialNumber.toLowerCase().includes(searchSN)) {
                        hasSNMatch = true;
                    }
            ...
            if (searchInstallationDate.length > 0 && installationDate && installationDate.includes(searchInstallationDate)) {
                hasDateMatch = true;
            }
            if (searchUser.length > 0 && !user.account.toLowerCase().includes(searchUser) && !(user.email ?? "").toLowerCase().includes(searchUser) && !(user.phone ?? "").toLowerCase().includes(searchUser)) {
                continue;
            }
    ...
    buildMonitorUserCsv(items) {
        ...
        const rows = items.map((item)=>[
                ...
                escape(`online:${item.status.online}, abnormal:${item.status.abnormal}, Standby:${item.status.standby}, Offline:${item.status.offline},`)
            ]);
        return [
            headers.join(','),
    ...
    async getMonitorUserList(actorId, actorRole, query) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor) {
            return actor;
        }
        const loginUser = actor;
    ...
    async exportMonitorUsers(actorId, actorRole, query) {
    ...
    async getMonitorUserStatusCounts(actorId, actorRole, query) {
        const actor = await this.validateActor(actorId, actorRole);
        if ('status' in actor) {
            return actor;
        }
        ...
        const counts = await this.monitorUserRepository.getPlantStatusCountsForUsers(accounts);
        return {
            status: 200,
    ...
    async getMonitorUserLiveSummary(actorId, actorRole, monitorUserIds) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor && actor.status !== undefined) {
            return actor;
        }
        const scopedUsers = await this.monitorUserRepository.findScopedMonitorUsersByIds(actorId, actorRole, monitorUserIds);
    ...
    async getMonitorUserPlants(actorId, actorRole, monitorUserId, query) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor && actor.status !== undefined) {
            return actor;
        }
        const monitorUser = await this.monitorUserRepository.findScopedMonitorUser(actorId, actorRole, monitorUserId);
        if (!monitorUser) {
            return {
                status: 403,
        ...
        const [totalItems, plants] = await Promise.all([
            ...
            this.monitorUserRepository.findPlantsByUserAccount(monitorUser.account, query.page, query.pageSize)
        ]);
        const plantIds = plants.map((plant)=>plant.id);
        const [inverters, dataloggers] = plantIds.length > 0 ? await Promise.all([
    ...
    async validateTargetServiceUser(targetUserId, actorId) {
    ...
    async updateMonitorUsersOwnership(monitorUserIdentifiers, actorId, actorRole, targetUserId) {
        const exactIds = [];
        const accounts = [];
        ...
        if (accounts.length > 0) {
            const usersByAccount = await this.monitorUserRepository.findUserIdsByAccounts(accounts);
        ...
        const scopedUsers = await this.monitorUserRepository.findScopedMonitorUserIds(actorId, actorRole, uniqueIds);
        ...
        const updated = await this.monitorUserRepository.updateMonitorUsersAssignedBy(actorId, actorRole, uniqueIds, targetUserId);
        return {
            error: null,
    ...
    // 	}
    // }
    async relateMonitorUsers(actorId, actorRole, input) {
        const actor = await this.validateActor(actorId, actorRole);
        if ('status' in actor) {
            return actor;
        }
        const user = await this.monitorUserRepository.findMonitorUserByAccount(input.account);
        if (!user) {
            return {
                status: 404,
        ...
        const existing = await this.monitorUserRepository.findMappingBySerialNumber(input.serialNumber);
        if (existing) {
            return {
                status: 409,
        ...
        await this.monitorUserRepository.createUserPlantMapping(user.id, input.serialNumber);
        return {
            status: 200,
    ...
    async assignMonitorUsers(actorId, actorRole, input) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor && actor.status !== undefined) {
            return actor;
        }
        ...
        try {
            const updated = await this.updateMonitorUsersOwnership(input.monitorUserIds.map(String), actorId, actorRole, input.assignedToUserId);
            if (updated.error) {
                return updated.error;
            }
            return {
            ...
            return {
                status: 500,
                message: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toErrorMessage"])(error)
            };
        }
    }
    async createMonitorUser(actorId, actorRole, input) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor && actor.status !== undefined) {
            return actor;
        }
        ...
        const existingEmail = await this.monitorUserRepository.findMonitoringUserByEmail(input.email);
        if (existingEmail) {
            return {
                status: 409,
        ...
        try {
            const passwordHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(input.password);
    ...
    async getDashboardSummary(actorId, actorRole) {
        const actor = await this.validateActor(actorId, actorRole);
        if ("status" in actor) {
            return actor;
        }
        const totals = await this.monitorUserRepository.getDashboardSummary(actorId, actor.role);
        return {
            status: 200,
...
"[project]/src/server/validators/monitor-user.validator.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "assignMonitorUsersBodySchema",
    ()=>assignMonitorUsersBodySchema,
    "createMonitorUserBodySchema",
    ()=>createMonitorUserBodySchema,
    "monitorUserIdParamSchema",
    ()=>monitorUserIdParamSchema,
    "monitorUserListQuerySchema",
    ()=>monitorUserListQuerySchema,
    "monitorUserLiveSummaryQuerySchema",
    ()=>monitorUserLiveSummaryQuerySchema,
    "monitorUserPlantsQuerySchema",
    ()=>monitorUserPlantsQuerySchema,
    "monitorUserStatusCountsQuerySchema",
    ()=>monitorUserStatusCountsQuerySchema,
    "relateMonitorUsersBodySchema",
    ()=>relateMonitorUsersBodySchema,
    "relateUserBodySchema",
    ()=>relateUserBodySchema
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v4/classic/external.js [app-route] (ecmascript) <export * as z>");
;
const numberStringSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d+$/).transform((value)=>Number(value));
const idStringSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d+$/, "Id must be a positive integer").refine((value)=>{
    try {
        return BigInt(value) > BigInt(0);
    } catch  {
        return false;
    }
}, "Id must be a positive integer").transform((value)=>BigInt(value));
const monitorUserIdParamSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    monitorUserId: idStringSchema
});
const monitorUserListQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    page: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].union([
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive(),
        numberStringSchema
    ]).optional().default(1),
    pageSize: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].union([
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive().max(100),
        numberStringSchema
    ]).optional().default(10).transform((value)=>Math.min(value, 100)),
    ...
    searchUser: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchSN: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchInstallationDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchAffiliation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default("")
});
const monitorUserStatusCountsQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    searchUser: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchSN: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchInstallationDate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default(""),
    searchAffiliation: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().optional().default("")
});
const monitorUserLiveSummaryQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    monitorUserIds: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, "monitorUserIds is required")
});
const monitorUserPlantsQuerySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    page: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].union([
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive(),
        numberStringSchema
    ]).optional().default(1),
...
const monitorUserIdsSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, "Identifier cannot be empty")).min(1, "At least one monitor user id or account name is required");
const relateMonitorUsersBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    monitorUserIds: monitorUserIdsSchema,
    relatedUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d+$/, "relatedUserId must be a positive integer").transform((value)=>BigInt(value))
});
const relateUserBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    account: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, 'Account is required'),
    serialNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, 'Serial number is required')
});
const assignMonitorUsersBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    monitorUserIds: monitorUserIdsSchema,
    assignedToUserId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d+$/, "assignedToUserId must be a positive integer").transform((value)=>BigInt(value))
});
const timezoneFormatSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^UTC[+-](0\d|1\d|2[0-3]):[0-5]\d$/, "Timezone must be in UTC±HH:MM format");
const phoneFormatSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().regex(/^\d{10,15}$/, "Phone must contain 10 to 15 digits");
const createMonitorUserBodySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    account: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, "Account is required"),
    ...
    confirmPassword: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(8, "Confirm password must be at least 8 characters"),
    email: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().email("Email must be valid"),
...
"[project]/src/app/api/v1/service/monitor-users/status-counts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$monitor$2d$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/services/monitor-user.service.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$monitor$2d$user$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/validators/monitor-user.validator.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$monitor$2d$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$monitor$2d$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
;
const monitorUserService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$services$2f$monitor$2d$user$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MonitorUserService"]();
async function getMonitorUserStatusCounts(request) {
    const authenticatedRequest = request;
    ...
    try {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Invalid token payload', 401);
    }
    const searchParams = new URL(request.url).searchParams;
    const parsedQuery = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$validators$2f$monitor$2d$user$2e$validator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["monitorUserStatusCountsQuerySchema"].safeParse({
    ...
    const result = await monitorUserService.getMonitorUserStatusCounts(actorId, actorRole, parsedQuery.data);
    if (result.status !== 200) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])(result.message, result.status);
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])(result.message, result.data);
}
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$request$2d$log$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withRequestLogging"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$middleware$2f$auth$2e$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(getMonitorUserStatusCounts), {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0g_325_._.js.map